...
exports.HealthStatusCard = HealthStatusCard;
const StatusChip_1 = require("./StatusChip");
function HealthStatusCard({ title, status, description, details }) {
    ...
    return (<div className="hub-card p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <StatusChip_1.StatusChip label={label} tone={status === "ok" ? "green" : status === "warning" ? "amber" : "red"}/>
      </div>
