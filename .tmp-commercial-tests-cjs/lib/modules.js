...
exports.getModuleByHref = getModuleByHref;
exports.modules = [
...
function getModuleByHref(pathname) {
    return exports.modules.find((module) => pathname === module.href || pathname.startsWith(`${module.href}/`));
}
