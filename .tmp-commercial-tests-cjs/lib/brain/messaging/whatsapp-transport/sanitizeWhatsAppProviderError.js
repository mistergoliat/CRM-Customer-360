...
exports.sanitizeWhatsAppProviderError = sanitizeWhatsAppProviderError;
exports.extractSafeWhatsAppProviderError = extractSafeWhatsAppProviderError;
...
function sanitizeWhatsAppProviderError(input, limit = 240) {
...
function extractSafeWhatsAppProviderError(body) {
    if (!isRecord(body)) {
        return {
            providerCode: null,
