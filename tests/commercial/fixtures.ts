import type { BrainActionResolveResponse } from "../../lib/brain/actions/types";
import type { BrainBotEligibility, BrainContextSummary, BrainInboundSource, BrainNormalizedProcessInboundRequest } from "../../lib/brain/inbound/types";
import type { BrainContextResolveResponse } from "../../lib/brain/context/types";
import type { CommercialPolicyFeatureFlags } from "../../lib/brain/commercial/policy";
import { COMMERCIAL_POLICY_DEFAULT_FLAGS } from "../../lib/brain/commercial/policy";
import { COMMERCIAL_SHADOW_DEFAULT_FEATURE_FLAGS } from "../../lib/brain/commercial/shadow";
import type { CommercialShadowFeatureFlags, CommercialShadowInput } from "../../lib/brain/commercial/shadow";
...
export const FIXED_TIME = "2026-06-17T12:00:00.000Z";
export const FIXED_NOW = Date.parse(FIXED_TIME);
...
export function makeRecentMessage(index: number): BrainContextResolveResponse["conversation_context"]["recent_messages"][number] {
...
export function makeBrainContextResolveResponse(overrides: Record<string, unknown> = {}): BrainContextResolveResponse {
  return {
    ok: true,
...
export function makeNormalizedInboundMessage(overrides: Record<string, unknown> = {}): BrainNormalizedProcessInboundRequest {
  return {
    channel: "whatsapp",
    source: "manual_test",
...
export function makeCommercialShadowFlags(overrides: Partial<CommercialShadowFeatureFlags> = {}): CommercialShadowFeatureFlags {
  return {
...
export function makeCommercialPolicyFlags(overrides: Partial<CommercialPolicyFeatureFlags> = {}): CommercialPolicyFeatureFlags {
  return {
...
export function makeBrainContextSummary(): BrainContextSummary {
  return {
...
export function makeBrainActionResolveResponse(overrides: Partial<BrainActionResolveResponse> = {}): BrainActionResolveResponse {
...
export function makeCommercialShadowInput(overrides: Partial<CommercialShadowInput> = {}): CommercialShadowInput {
  return {
...
export function makeInboundRequest(overrides: Record<string, unknown> = {}) {
  return {
    channel: "whatsapp",
    source: "manual_test",
    contextMode: "standard",
