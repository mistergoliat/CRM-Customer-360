...
`ACS-R1-04-T06` debe conectar identidad y onboarding al inbound nativo: resolucion de identidad (T02/T02.1), onboarding multi-turno (T03/T03.1) y el `CustomerServicePort` (T04.1) pasan de "implementado, no conectado" a conectados al runtime real, sin reabrir las reglas de autoridad ya definidas en [customer-creation-linking-authority-contract](../data/customer-creation-linking-authority-contract.md) ni la separacion de Customer 360 como historia (no identidad) fijada en `ACS-R1-04-T05`.
