...
export function ModulePreview({ title, icon, description, planned, partial }: ModulePreviewProps) {
  return (
            ...
            <div className="flex gap-4">
              ...
              <div>
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  ...
                  <StatusChip label="Preview" tone="red" />
                  <StatusChip label="Próximamente" tone="amber" />
                  <StatusChip label="No conectado" tone="gray" />
                </div>
