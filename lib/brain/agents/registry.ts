import type { BrainAgentDefinition, BrainAgentName } from "./types";

export const BRAIN_AGENT_REGISTRY: Record<BrainAgentName, BrainAgentDefinition> = {
  knowledge: {
    name: "knowledge",
...
export function getBrainAgentDefinition(agentName: BrainAgentName) {
  return BRAIN_AGENT_REGISTRY[agentName];
}

export function listBrainAgentDefinitions() {
  return Object.values(BRAIN_AGENT_REGISTRY);
}

export function isBrainAgentRunnable(agentName: BrainAgentName) {
