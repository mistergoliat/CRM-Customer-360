...
import { isMarketingCopilotClientError, refreshCopilotSession } from "@/lib/customer-intelligence/copilotClient";
...
export async function POST(_request: Request, context: Context) {
  ...
  try {
    const upstream = await refreshCopilotSession(sessionId);
